...
# installed.
TCL_PREFIX='D:/Learning materials/机器学习/env/MNIST/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Learning materials/机器学习/env/MNIST/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Learning materials/机器学习/env/MNIST/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Learning materials/机器学习/env/MNIST/.conda\Library\include'
...
TCL_PACKAGE_PATH='D:/Learning materials/机器学习/env/MNIST/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Learning materials/机器学习/env/MNIST/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Learning materials/机器学习/env/MNIST/.conda\Library\lib\tclstub86.lib'
